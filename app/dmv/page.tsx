      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 flex flex-col px-6 py-20">
        ...
        >
          ...
          <section className="text-gray-800 px-4">
            <h1 className="text-4xl font-bold text-purple-700 mb-6">DMV VISION TEST</h1>
            <p className="text-lg leading-relaxed max-w-xl mb-6">
                Our pharmacy is proud to offer DMV-approved vision test services, making it easier than ever to renew your driver’s license without the hassle of visiting a DMV office. Our certified professionals provide quick and accurate vision screenings that meet New York State DMV requirements, ensuring your eyesight is safe for driving. Whether you're renewing your license or just need to confirm your vision health, our convenient in-store service saves you time and stress. Once your test is complete, we submit the results electronically to the DMV on your behalf. No appointment necessary—just stop by and get it done in minutes. Your convenience and safety are our priority. </p>
            <a
